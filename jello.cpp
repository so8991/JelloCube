...
{
    counter.StopCounter();
    //printf("FPS: %d\n", (int)10000*counter.GetElapsedTime());
    //printf("time : %lf", counter.GetElapsedTime());
  ...
  if ((int)(10000*counter.GetElapsedTime())%2 ==0)
  {
    ...
    //saveScreenToFile=2; // save only once, change this if you want continuos image generation (i.e. animation)
    sprite++;
  }
...
int main (int argc, char ** argv)
{
  ...
  glutPassiveMotionFunc(mouseMotion);
   ...
   // glutMouseFunc(getMouseLocation);
